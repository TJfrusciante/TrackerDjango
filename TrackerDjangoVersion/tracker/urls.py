...
urlpatterns = [
    ...
    path('transacoes/desfazer/limpar/', views.transaction_undo_clear, name='transaction_undo_clear'),
    path('transacoes/desfazer-lote/', views.transaction_bulk_undo_delete, name='transaction_bulk_undo_delete'),
    path('transacoes/desfazer-lote/limpar/', views.transaction_bulk_undo_clear, name='transaction_bulk_undo_clear'),
    ...
    path('tarefas/desfazer/limpar/', views.task_undo_clear, name='task_undo_clear'),
    path('tarefas/desfazer-lote/', views.task_bulk_undo_delete, name='task_bulk_undo_delete'),
    path('tarefas/desfazer-lote/limpar/', views.task_bulk_undo_clear, name='task_bulk_undo_clear'),
    ...
    path('categorias/tarefas/<int:pk>/editar/', views.task_category_edit, name='task_category_edit'),
    path('categorias/tarefas/<int:pk>/excluir/', views.task_category_delete, name='task_category_delete'),
]
